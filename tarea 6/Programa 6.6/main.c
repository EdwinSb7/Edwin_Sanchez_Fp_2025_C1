...
/* Intercambia.
El programa intercambia las columnas de un arreglo bidimensional. Los elementos de la primera columna se intercambian
con los de la última, los de la segunda con los de la penúltima, y así sucesivamente. */
...
void Intercambia(float A[][MAX], int F, int C)
{
    ...
    bidimensional. Observa que el índice correspondiente a las columnas solo se
