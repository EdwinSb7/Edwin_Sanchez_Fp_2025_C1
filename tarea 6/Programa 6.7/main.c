...
{
    /* Esta funcion se utiliza para almacenar en el arreglo bidimensional las diferentes transacciones que representan
    las ventas de los diferentes productos.
    El fin de datos está dado por –1. */
...
{
    /* Esta funciin se utiliza para calcular el monto total de ventas de la fabrica. */
...
{
    /* Esta funcion se utiliza para obtener el tipo de producto que más se ha vendido
