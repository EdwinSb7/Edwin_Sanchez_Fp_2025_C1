...
void Ventas(producto A[], int T) {
    /* Esta funcion se utiliza para manejar las ventas a un cliente. Se ingresan productos y cantidades, el fin de datos esta dado por el cero. */
    int CLA, CAN, I, RES;
    float TOT, PAR;
...
void Inventario(producto A[], int T) {
    /* Esta funcion se utiliza para escribir la informacion almacenada en el inventario. */
    int I;
    for (I = 0; I < T; I++) {
        printf("\nClave: %d", A[I].clave);
